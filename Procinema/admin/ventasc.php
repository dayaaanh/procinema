                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Reporte Venta Operarios</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Reporte venta operarios</strong>
                            </div>
                            <div class="card-body">
                              <table width=80% >  
                               <td ><a href="reportePDF3.php" target="_blank"><img src="images/pdf.png"></a><small class="form-text text-muted">Visualizar reporte en PDF</small> </td>
                                 <td colspan="3"><a href="reporteExcel3.php" target="_blank"> <img src="images/excel.png"><small class="form-text text-muted">Visualizar reporte en Excel</small> </td></a></td>
                            </table>
                            </div>
