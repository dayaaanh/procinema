...
<head>
    ...
    <title>Procinema - USUARIOS</title>
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="../logout.php"> <i class="menu-icon fa fa-sign-out"></i>Salir</a>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        require_once($_SERVER["DOCUMENT_ROOT"] .'/procinema/procinema/daos/MultiplexDAO.php');
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            {
                                              if($usuario->getCod_Multiplex() == $_SESSION['multiplex'])
                                              {
                                        ...
                                        <tr align="center">
                                            ...
                                            <td><?php echo $t_usuarioDAO->consultarTUsuario($usuario->getCod_t_usuario())->getNom_t_usuario(); ?></td>
                                            <td><?php echo $usuario->getSalario(); ?></td>
                                            <td><?php echo $usuario->getFecha_Contrato(); ?></td>
                                            <td><?php echo $usuario->getCorreo(); ?></td>
                                            <td><?php echo $usuario->getPassword(); ?></td>
                                            <td><a href="editarUsuario.php?codigo=<?php echo $usuario->getCod_usuario(); ?>"> <i class="menu-icon fa fa-pencil-square-o"></i></a></td>
                                        </tr>
                                      <?php
                                            }
                                          }
                            ...
                            <div class="card-header">
                                <a href="nuevoUsuario.php"><strong><i class="menu-icon fa fa-plus"></i> Nuevo Usuario</strong></a>
                            </div>
                        </div>
                    </div>
