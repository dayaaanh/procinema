                    ...
                    <div class="medio">
                        <div class="card">
                            <div class="card-header">
                                <strong>Nuevo Sala</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="nuevaSalaSubmit.php" method="post" enctype="multipart/form-data" class="form-horizontal">

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nombre</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="nombre" placeholder="NOMBRE" class="form-control"><small class="form-text text-muted">Ingrese el nombre de la sala</small></div>
                                    </div>
