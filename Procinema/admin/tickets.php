                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr align="center">
                                            ...
                                            <td>Activo</td>
                                            <td>$43000</td>
                                            <td><a href="editarTicket.php"> <i class="menu-icon fa fa-pencil-square-o"></i></a></td>
                                            <td><a href="widgets.html"> <i class="menu-icon fa fa-minus-circle"></i></a></td>
                                        </tr>
                            ...
                            <div class="card-header">
                                <a href="nuevoTicket.php"><strong><i class="menu-icon fa fa-plus"></i> Nuevo Ticket</strong></a>
                            </div>
                        </div>
                    </div>
