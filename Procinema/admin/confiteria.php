                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Confiteria</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr align="center">
                                            <td>1</td>
                                            <td>Combo 1</td>
                                            <td>Palomitas con Gaseosa</td>
                                            <td>5</td>
                                            <td>20000</td>
                                            <td><a href="editarConfiteria.php"> <i class="menu-icon fa fa-pencil-square-o"></i></a></td>
                                        </tr>
                            ...
                            <div class="card-header">
                              <a href="nuevaConfiteria.php"><strong><i class="menu-icon fa fa-plus"></i> Nueva Confiteria</strong></a>
                            </div>
                        </div>
                    </div>
