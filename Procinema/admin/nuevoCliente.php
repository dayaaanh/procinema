                    ...
                    <div class="medio">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="nuevoClienteSubmit.php" method="post" enctype="multipart/form-data" class="form-horizontal">

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nombre</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="nombre" placeholder="NOMBRE" class="form-control"><small class="form-text text-muted">Ingrese el nombre del cliente</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Correo electrónico</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="correo" placeholder="CORREO ELECTRÓNICO" class="form-control"><small class="form-text text-muted">Ingrese el correo electrónico del cliente</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Puntos</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="text-input" name="puntos"  placeholder="PUNTOS" class="form-control"><small class="form-text text-muted">Ingrese la cantidad de puntos del cliente</small></div>
                                    </div>
