...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        $usuario = $usuarioDAO->consultarUsuario($_GET['codigo']);
                    ...
                    <div class="medio">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="editarUsuarioSubmit.php?codigo=<?php echo $usuario->getCod_usuario(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nombre</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="nombre" value=<?php echo $usuario->getNom_usuario(); ?> class="form-control"><small class="form-text text-muted">Ingrese el nombre del usuario</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Salario</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="text-input" name="salario" value=<?php echo $usuario->getSalario(); ?> class="form-control"><small class="form-text text-muted">Ingrese el salario del usuario</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Fecha de contrato</label></div>
                                        <div class="col-12 col-md-9"><input type="date" id="text-input" name="fecha"  value=<?php echo $usuario->getFecha_Contrato(); ?> class="form-control"><small class="form-text text-muted">Ingrese la fecha de contrato del usuario</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Correo</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="correo" value=<?php echo $usuario->getCorreo(); ?> class="form-control"><small class="form-text text-muted">Ingrese el correo del usuario</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Contraseña</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="password" value=<?php echo $usuario->getPassword(); ?> class="form-control"><small class="form-text text-muted">Ingrese la contraseña del usuario</small></div>
                                    </div>
