                    ...
                    <div class="medio">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="nuevoUsuarioSubmit.php" method="post" enctype="multipart/form-data" class="form-horizontal">

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Cédula</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="codigo" placeholder="CÉDULA" class="form-control"><small class="form-text text-muted">Ingrese la cédula del usuario</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nombre</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="nombre" placeholder="NOMBRE" class="form-control"><small class="form-text text-muted">Ingrese el nombre del usuario</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Salario</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="text-input" name="salario" placeholder="SALARIO" class="form-control"><small class="form-text text-muted">Ingrese el salario del usuario</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Fecha de contrato</label></div>
                                        <div class="col-12 col-md-9"><input type="date" id="text-input" name="fecha"  class="form-control"><small class="form-text text-muted">Ingrese la fecha de contrato del usuario</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Correo</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="correo" placeholder="CORREO" class="form-control"><small class="form-text text-muted">Ingrese el correo del usuario</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Contraseña</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="password" placeholder="CONTRASEÑA" class="form-control"><small class="form-text text-muted">Ingrese la contraseña del usuario</small></div>
                                    </div>
