...
<head>
    ...
    <title>Procinema - CLIENTES</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="center">
                                            ...
                                            <td><?php echo $cliente->getPuntos(); ?></td>
                                            <td><a href="editarCliente.php?codigo=<?php echo $cliente->getCod_cliente(); ?>&nombre=<?php echo $cliente->getNom_cliente(); ?>&correo=<?php echo $cliente->getEmail(); ?>&puntos=<?php echo $cliente->getPuntos(); ?>"> <i class="menu-icon fa fa-pencil-square-o"></i></a></td>
                                        </tr>
                                      <?php
                                          }
                                      ?>
                            ...
                            <div class="card-header">
                                <a href="nuevocliente.php"><i class="menu-icon fa fa-plus"></i><strong> Nuevo Cliente</strong></a>
                            </div>
                        </div>
                    </div>
