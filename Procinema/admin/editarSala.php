                    ...
                    <div class="medio">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="editarSalaSubmit.php?codigo=<?php echo $codigo ?>" method="post" enctype="multipart/form-data" class="form-horizontal">

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nombre</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="nombre" value=<?php echo $nombre ?> class="form-control"><small class="form-text text-muted">Ingrese el nombre de la sala</small></div>
                                    </div>
