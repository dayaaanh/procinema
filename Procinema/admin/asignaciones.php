...
<head>
    ...
    <title>Procinema - ASIGNACIONES</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Asignaciones</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr align="center">
                                            <td>1</td>
                                            <td>Dayan Hincapie</td>
                                            <td>Dayan@hotmail.com</td>
                                            <td><a href="editarAsignacion.php"> <i class="menu-icon fa fa-pencil-square-o"></i></a></td>
                                        </tr>
                            ...
                            <div class="card-header">
                                <a href="nuevaAsignacion.php"><i class="menu-icon fa fa-plus"></i><strong> Nueva Asignación</strong></a>
                            </div>
                        </div>
                    </div>
