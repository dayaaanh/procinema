                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Salas</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="center">
                                            <td><?php echo $sala->getCod_sala(); ?></td>
                                            <td><?php echo $sala->getNom_sala(); ?></td>
                                            <td><a href="editarSala.php?codigo=<?php echo $sala->getCod_sala(); ?>&nombre=<?php echo $sala->getNom_sala(); ?>"> <i class="menu-icon fa fa-pencil-square-o"></i></a></td>
                                        </tr>
                                      <?php
                                          }
                                      ?>
                            ...
                            <div class="card-header">
                                <a href="nuevaSala.php"><i class="menu-icon fa fa-plus"></i><strong> Nueva Sala</strong></a>
                            </div>
                        </div>
                    </div>
