                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Nueva Confiteria</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="medio">
                        <div class="card">
                            <div class="card-header">
                                <strong>Nueva Confiteria</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input" placeholder="NOMBRE" class="form-control"><small class="form-text text-muted">Ingrese el nombre de la confiteria</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Descripción</label></div>
                                        <div class="col-12 col-md-9"><textarea name="textarea-input" id="textarea-input" rows="9" placeholder="DESCRIPCIÓN" class="form-control"></textarea><small class="form-text text-muted">Ingrese la descripción de la película</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Cantidad</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="text-input" name="text-input"  placeholder="CANTIDAD" class="form-control"><small class="form-text text-muted">Ingrese la cantidad existente</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Precio</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="text-input" name="text-input" placeholder="PRECIO" class="form-control"><small class="form-text text-muted">Ingrese el precio de la confiteria</small></div>
                                    </div>

                                </form>
                                <div class="form-actions form-group">
                                    <button type="submit" class="btn btn-outline-success btn-sm">
                                        <i class="fa fa-plus"></i> Nueva confiteria
                                    </button>
