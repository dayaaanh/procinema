                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Nueva Película</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body card-block">
                                <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                  ...
                                  <div class="row form-group">
                                      ...
                                      <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input" placeholder="NOMBRE" class="form-control"><small class="form-text text-muted">Ingrese el nombre de la película</small></div>
                                  </div>
                                  <div class="row form-group">
                                      ...
                                      <div class="col-12 col-md-9">
                                          ...
                                          <small class="form-text text-muted">Seleccione el género de la película</small>
                                      </div>
                                  </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Idioma</label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="select" id="select" class="form-control">
                                                <option value="0">Please select</option>
                                                <option value="1">Option #1</option>
                                            ...
                                            <small class="form-text text-muted">Seleccione el idioma de la película</small>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Duración</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input" placeholder="DURACIÓN" class="form-control"><small class="form-text text-muted">Ingrese la duración de la película</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Horario</label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="select" id="select" class="form-control">
                                                <option value="0">Please select</option>
                                                <option value="1">Option #1</option>
                                            ...
                                            <small class="form-text text-muted">Seleccione el horario de la película</small>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Calificación</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="text-input" name="text-input" placeholder="CALIFICACIÓN" class="form-control"><small class="form-text text-muted">Ingrese la calificación de la película</small></div>
                                    </div>
