                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Reporte clientes</strong>
                            </div>
                            <div class="card-body">
                              <table width=80% >  
                               <td ><a href="reportePDF1.php" target="_blank"><img src="images/pdf.png"></a><small class="form-text text-muted">Visualizar reporte en PDF</small> </td>
                                 <td colspan="3"><a href="reporteExcel1.php" target="_blank"> <img src="images/excel.png"><small class="form-text text-muted">Visualizar reporte en Excel</small> </td></a></td>
                            </table>
                            </div>
