		...
		<div class="container">
			<div class="row">
				...
				<?php $pelicula3 = $PeliculaDAO->consultarPelicula(3); ?>
					<h1 class="details__title"><?php echo $pelicula3->getNom_pelicula() ?></h1>
				</div>
				<!-- end title -->
						...
						<div class="row">
							...
							<div class="col-12 col-xl-7">
								<div class="card__content">
									...
									<?php $cal = (string)$pelicula3->getCalificacion() ?>
									...
									<ul class="card__meta">
										<?php
										$genero = $T_GeneroDAO->consultarGenero(3)->getNom_genero();
										$fecha = (string)$pelicula3->getFecha();
										$duracion = (string)$pelicula3->getDuracion();					
										?>
