...
<head>
	...
	<title>Procinema - El hombre invisible</title>
		...
		<div class="container">
			<div class="row">
				...
				<?php $pelicula4 = $PeliculaDAO->consultarPelicula(4); ?>
					<h1 class="details__title"><?php echo $pelicula4->getNom_pelicula() ?></h1>
				</div>
				<!-- end title -->
						...
						<div class="row">
							...
							<div class="col-12 col-xl-7">
								<div class="card__content">
									...
									<?php $cal = (string)$pelicula4->getCalificacion() ?>
									...
									<ul class="card__meta">
										<?php
										$genero = $T_GeneroDAO->consultarGenero(8)->getNom_genero();
										$fecha = (string)$pelicula4->getFecha();
										$duracion = (string)$pelicula4->getDuracion();					
										?>
								...
								<div class="accordion__card">
									<div class="card-header" id="headingOne">
										<button type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
											...
											<?php											
											$idioma = $Idioma->consultarIdioma(2)->getNom_Idioma();																
											?>
