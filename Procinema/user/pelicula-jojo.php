...
<head>
	...
	<title>Procinema - JojoRabbit</title>
		...
		<div class="container">
			<div class="row">
				...
				<?php $pelicula2 = $PeliculaDAO->consultarPelicula(1); ?>
					<h1 class="details__title"><?php echo $pelicula2->getNom_pelicula() ?></h1>
				</div>
				<!-- end title -->
						...
						<div class="row">
							...
							<div class="col-12 col-xl-7">
								<div class="card__content">
									...
									<?php $cal = (string)$pelicula2->getCalificacion() ?>
									...
									<ul class="card__meta">
										<?php
										$genero = $T_GeneroDAO->consultarGenero(1)->getNom_genero();
										$fecha = (string)$pelicula2->getFecha();
										$duracion = (string)$pelicula2->getDuracion();					
										?>
