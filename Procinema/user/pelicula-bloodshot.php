...
<head>
	...
	<title>Procinema - Bloodshot</title>
		...
		<div class="container">
			<div class="row">
				...
				<?php $pelicula6 = $PeliculaDAO->consultarPelicula(6); ?>
					<h1 class="details__title"><?php echo $pelicula6->getNom_pelicula() ?></h1>
				</div>
				<!-- end title -->
						...
						<div class="row">
							...
							<div class="col-12 col-xl-7">
								<div class="card__content">
									...
									<?php $cal = (string)$pelicula6->getCalificacion() ?>
									...
									<ul class="card__meta">
									<?php
										$genero = $T_GeneroDAO->consultarGenero(2)->getNom_genero();
										$fecha = (string)$pelicula6->getFecha();
										$duracion = (string)$pelicula6->getDuracion();					
										?>
