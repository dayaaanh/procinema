						...
						<form action="calificacionS_validar.php" class="sign__form" method="post">
                        	  ...
                        	  $port = "3306";
                      		  $conexion = mysqli_connect($server, $user, $pass,$bd,$port)
                  			   ...
                  			   ?>
   							    ...
   							    <select name="selectA" id="selectA" class="sign__input" required="true">
              				  <option value="0">Selecciona la pelicula</option>
              				  <?php
                 			   while ($row = $result->fetch_assoc()):?>

                   			 <option value=" <?php echo $row['cod_pelicula']; ?> ">

                    		    <?php echo $row['nom_pelicula']; ?>
                   			 </option>
                  			  <?php endwhile; ?>
							</select>
							...
							<div class="sign__group">
								...
								<select name="selectB" id="selectA" class="sign__input" required="true">
									<option value="0">Ingrese la calificación</option> 
							...
							<button class="sign__btn" type="submit" >Calificar pelicula</button>
							<span class="sign__text"><a href="calificacionS.php">Calificar servicios de Cine Jungla</a></span>
